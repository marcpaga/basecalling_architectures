...
class CausalCallConvBlock(nn.Module):
    ...
    def __init__(self, 
        ...
        self.conv1 = CausalConv1d(self.first_channel, self.num_channels, self.kernel_size, 1, self.dilation)
        self.conv2 = CausalConv1d(int(self.num_channels/2), self.num_channels, self.kernel_size, 1, self.dilation)
